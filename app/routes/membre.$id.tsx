  ...
  return (
    <main className="min-h-screen bg-bg-darker py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {member.countdown_started_at && (
          <motion.div
            className={`mt-6 p-4 md:p-8 border text-center ${
              isCountdownExpired
            ...
            {isCountdownExpired ? (
              ...
              <>
                ...
                <div className="flex justify-center items-center gap-2 sm:gap-3 md:gap-4">
                  <div className="text-center">
                    <div className="font-display text-3xl sm:text-4xl md:text-5xl text-text-primary">{countdown.days}</div>
                    <div className="font-body text-[10px] md:text-xs text-text-secondary uppercase mt-1">jours</div>
                  </div>
                  <span className="font-display text-xl sm:text-2xl md:text-3xl text-accent">:</span>
                  <div className="text-center">
                    <div className="font-display text-3xl sm:text-4xl md:text-5xl text-text-primary">{String(countdown.hours).padStart(2, '0')}</div>
                    <div className="font-body text-[10px] md:text-xs text-text-secondary uppercase mt-1">heures</div>
                  </div>
                  <span className="font-display text-xl sm:text-2xl md:text-3xl text-accent">:</span>
                  <div className="text-center">
                    <div className="font-display text-3xl sm:text-4xl md:text-5xl text-text-primary">{String(countdown.minutes).padStart(2, '0')}</div>
                    <div className="font-body text-[10px] md:text-xs text-text-secondary uppercase mt-1">min</div>
                  </div>
                  <span className="font-display text-xl sm:text-2xl md:text-3xl text-accent animate-pulse">:</span>
                  <div className="text-center">
                    <div className="font-display text-3xl sm:text-4xl md:text-5xl text-accent">{String(countdown.seconds).padStart(2, '0')}</div>
